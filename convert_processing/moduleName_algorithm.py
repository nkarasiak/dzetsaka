...
class classNameAlgorithm(GeoAlgorithm):
    ...
    def defineCharacteristics(self):
        ...
        # add num
        self.addParameter(ParameterNumber(self.MEDIAN_ITER,self.tr('Number of iteration for median filter')))
        
        # add num
        self.addParameter(ParameterNumber(self.MEDIAN_SIZE,self.tr('Window size of median filter')))
