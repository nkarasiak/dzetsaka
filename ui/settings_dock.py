...
class Ui_settingsDock(object):
    def setupUi(self, settingsDock):
        ...
        self.selectClassifier.addItem("")
        self.selectClassifier.addItem("")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.selectClassifier)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.classSuffix)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.classPrefix)
    ...
    def retranslateUi(self, settingsDock):
        ...
        self.selectClassifier.setItemText(2, _translate("settingsDock", "Support Vector Machines"))
