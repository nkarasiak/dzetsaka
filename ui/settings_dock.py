...
class Ui_settingsDock(object):
    def setupUi(self, settingsDock):
        ...
        self.formLayout.setWidget(
            0, QtWidgets.QFormLayout.FieldRole, self.selectClassifier
        )
        ...
        self.selectProviders.addItem("")
        self.formLayout.setWidget(
            4, QtWidgets.QFormLayout.FieldRole, self.selectProviders
        )
    ...
    def retranslateUi(self, settingsDock):
        ...
        settingsDock.setWindowTitle(
            _translate("settingsDock", "dzetsaka : settings panel")
        )
        self.label.setText(_translate("settingsDock", "Classifier :"))
        self.selectClassifier.setItemText(
            0, _translate("settingsDock", "Gaussian Mixture Model")
        )
        self.selectClassifier.setItemText(
            1, _translate("settingsDock", "Random Forest")
        )
        self.selectClassifier.setItemText(
            2, _translate("settingsDock", "Support Vector Machine")
        )
        self.selectClassifier.setItemText(
        ...
        self.selectClassifier.setItemText(6, _translate("settingsDock", "Extra Trees"))
        self.selectClassifier.setItemText(
            7, _translate("settingsDock", "Gradient Boosting Classifier")
        )
        self.selectClassifier.setItemText(
            8, _translate("settingsDock", "Logistic Regression")
        )
        self.selectClassifier.setItemText(
            9, _translate("settingsDock", "Gaussian Naive Bayes")
        )
        self.selectClassifier.setItemText(
            10, _translate("settingsDock", "Multi-layer Perceptron")
        )
