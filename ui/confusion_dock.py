...
class Ui_confusionDock(object):
    def setupUi(self, confusionDock):
        ...
        self.gridLayout.addWidget(self.inRaster, 0, 2, 1, 4)
        ...
        self.gridLayout.addWidget(self.inShape, 1, 2, 1, 4)
        ...
        self.gridLayout.addWidget(self.inField, 2, 2, 1, 4)
        ...
        self.gridLayout.addWidget(self.compare, 3, 4, 1, 2)
        ...
        self.saveas = QtGui.QPushButton(confusionDock)
        self.saveas.setObjectName(_fromUtf8("saveas"))
        self.gridLayout.addWidget(self.saveas, 4, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.confusionTable, 5, 0, 1, 6)
    ...
    def retranslateUi(self, confusionDock):
        ...
        self.saveas.setText(_translate("confusionDock", "Save as...", None))
