...
class shannonAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters,context,feedback):
        ...
        #on importe l'image
        im=ouvrir_raster(INPUT_RASTER_src)
        ...
        enregistrer_raster(OUTPUT_RASTER,im2,GeoTransform,Projection)
...
def enregistrer_raster(nomSortie, image, GeoTransform, Projection) :
    """
